...
// DownloadModel provides a mock function with given fields: localModelDirectory
func (_m *MockJobServiceProvider) DownloadModel(localModelDirectory string) error {
	ret := _m.Called(localModelDirectory)
...
func (_e *MockJobServiceProvider_Expecter) DownloadModel(localModelDirectory interface{}) *MockJobServiceProvider_DownloadModel_Call {
	return &MockJobServiceProvider_DownloadModel_Call{Call: _e.mock.On("DownloadModel", localModelDirectory)}
}

func (_c *MockJobServiceProvider_DownloadModel_Call) Run(run func(localModelDirectory string)) *MockJobServiceProvider_DownloadModel_Call {
...
func (_c *MockJobServiceProvider_DownloadModel_Call) RunAndReturn(run func(string) error) *MockJobServiceProvider_DownloadModel_Call {
	_c.Call.Return(run)
	return _c
}
