...
The following is a set of guidelines for contributing to Hedge and related services, which are
...
list](https://github.com/edgexfoundry/hedge/issues) to determine whether it already include the
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure
   ...
   git clone https://github.com/<your-username>/hedge.git

   # Navigate to the newly cloned directory
   cd hedge

   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/edgexfoundry/hedge.git
   ```
...
3. Create a new topic branch from `master` using the naming convention `HF-[issue-number]` to
   help us keep track of your contribution scope:

   ```bash
   git checkout -b HF-[issue-number]
   ```
...
6. Push your topic branch up to your fork:
   ...
   ```bash
   git push origin HF-[issue-number]
   ```
